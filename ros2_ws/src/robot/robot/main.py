...
def run(robot: Robot) -> None:
    ...
    while True:
        if state == "INIT":
            ...
            # Step 7: Print the current pose and current pursuit point to the console for debugging purposes.
            ...
            # Step 8: Check if the current target point is reached using the 
